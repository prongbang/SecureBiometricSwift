...
//  Source: https://github.com/algrid/keychain-sample/blob/master/keychain-sample/KeychainHelper.swift
...
public class KeychainAccessManager : KeychainManager {
    ...
    static let shared: KeychainManager = KeychainAccessManager()
    
    public init() {}
    
    public func getPwSecAccessControl() -> SecAccessControl {
    ...
    public func getBioSecAccessControl() -> SecAccessControl {
        var access: SecAccessControl?
        var error: Unmanaged<CFError>?
    ...
    public func createEntry(key: String, data: Data, password: String) -> OSStatus {
        remove(key: key)
    ...
    public func createBioProtectedEntry(key: String, data: Data) -> OSStatus {
        remove(key: key)
    ...
    public func loadPassProtected(key: String, context: LAContext?) -> Data? {
    ...
    public func available(key: String) -> Bool {
        let query = [
            kSecClass as String       : kSecClassGenericPassword,
            kSecAttrAccount as String : key,
            kSecReturnData as String  : kCFBooleanTrue,
    ...
    public func loadKey(name: String) -> SecKey? {
        let tag = name.data(using: .utf8)!
